...
comment11 = Comment.create(body: "I am so happy that it turned out so well", photo_id: photo11.id, user_id: user1.id )
...
comment1 = Comment.create(body: "I really love this picture", photo_id: photo13.id, user_id: user1.id )
comment2 = Comment.create(body: "I love the lighting", photo_id: photo13.id, user_id: user2.id )
comment3 = Comment.create(body: "This is a great photo idea", photo_id: photo13.id, user_id: user3.id )
comment4 = Comment.create(body: "I love this!!", photo_id: photo13.id, user_id: user4.id )
comment5 = Comment.create(body: "This a great photo", photo_id: photo13.id, user_id: user5.id )
comment6 = Comment.create(body: "Awesome photo", photo_id: photo13.id, user_id: user6.id )
comment7 = Comment.create(body: "This is amazing", photo_id: photo13.id, user_id: user7.id )
comment8 = Comment.create(body: "Love the colors", photo_id: photo13.id, user_id: user8.id )
comment9 = Comment.create(body: "You did a great job", photo_id: photo13.id, user_id: user9.id )
comment10 = Comment.create(body: "I'm a big fan of your work", photo_id: photo13.id, user_id: user10.id )
comment11 = Comment.create(body: "I am so happy that it turned put so well", photo_id: photo13.id, user_id: user1.id )
...
comment1 = Comment.create(body: "I really love this picture", photo_id: photo14.id, user_id: user1.id )
comment2 = Comment.create(body: "I love the lighting", photo_id: photo14.id, user_id: user2.id )
comment3 = Comment.create(body: "This is a great photo idea", photo_id: photo14.id, user_id: user3.id )
comment4 = Comment.create(body: "I love this!!", photo_id: photo14.id, user_id: user4.id )
comment5 = Comment.create(body: "This a great photo", photo_id: photo14.id, user_id: user5.id )
comment6 = Comment.create(body: "Awesome photo", photo_id: photo14.id, user_id: user6.id )
comment7 = Comment.create(body: "This is amazing", photo_id: photo14.id, user_id: user7.id )
comment8 = Comment.create(body: "Love the colors", photo_id: photo14.id, user_id: user8.id )
comment9 = Comment.create(body: "You did a great job", photo_id: photo14.id, user_id: user9.id )
comment10 = Comment.create(body: "I'm a big fan of your work", photo_id: photo14.id, user_id: user10.id )
comment11 = Comment.create(body: "I am so happy that it turned put so well", photo_id: photo14.id, user_id: user1.id )
...
comment1 = Comment.create(body: "I really love this picture", photo_id: photo15.id, user_id: user1.id )
comment2 = Comment.create(body: "I love the lighting", photo_id: photo15.id, user_id: user2.id )
comment3 = Comment.create(body: "This is a great photo idea", photo_id: photo15.id, user_id: user3.id )
comment4 = Comment.create(body: "I love this!!", photo_id: photo15.id, user_id: user4.id )
comment5 = Comment.create(body: "This a great photo", photo_id: photo15.id, user_id: user5.id )
comment6 = Comment.create(body: "Awesome photo", photo_id: photo15.id, user_id: user6.id )
comment7 = Comment.create(body: "This is amazing", photo_id: photo15.id, user_id: user7.id )
comment8 = Comment.create(body: "Love the colors", photo_id: photo15.id, user_id: user8.id )
comment9 = Comment.create(body: "You did a great job", photo_id: photo15.id, user_id: user9.id )
comment10 = Comment.create(body: "I'm a big fan of your work", photo_id: photo15.id, user_id: user10.id )
comment11 = Comment.create(body: "I am so happy that it turned put so well", photo_id: photo15.id, user_id: user1.id )
...
comment1 = Comment.create(body: "I really love this picture", photo_id: photo16.id, user_id: user1.id )
comment2 = Comment.create(body: "I love the lighting", photo_id: photo16.id, user_id: user2.id )
comment3 = Comment.create(body: "This is a great photo idea", photo_id: photo16.id, user_id: user3.id )
comment4 = Comment.create(body: "I love this!!", photo_id: photo16.id, user_id: user4.id )
comment5 = Comment.create(body: "This a great photo", photo_id: photo16.id, user_id: user5.id )
comment6 = Comment.create(body: "Awesome photo", photo_id: photo16.id, user_id: user6.id )
comment7 = Comment.create(body: "This is amazing", photo_id: photo16.id, user_id: user7.id )
comment8 = Comment.create(body: "Love the colors", photo_id: photo16.id, user_id: user8.id )
comment9 = Comment.create(body: "You did a great job", photo_id: photo16.id, user_id: user9.id )
comment10 = Comment.create(body: "I'm a big fan of your work", photo_id: photo16.id, user_id: user10.id )
comment11 = Comment.create(body: "I am so happy that it turned put so well", photo_id: photo16.id, user_id: user1.id )
